...
<div class="shopping-cart"> 
	...
	<table class="table" cellspacing="0">
		<thead>
			<tr>
				<th class="product-remove cart-romove item"> <?php esc_html_e( 'Remove', 'woocommerce' ); ?></th>
				<th class="product-thumbnail cart-description item"> <?php esc_html_e( 'Image', 'woocommerce' ); ?></th>
				<th class="product-name cart-product-name item"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
				<th class="product-price cart-sub-total item"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
				<th class="product-quantity cart-qty item"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
				<th class="product-subtotal cart-total last-item"><?php esc_html_e( 'Total', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
